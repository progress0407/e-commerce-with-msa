...
class ItemRabbitProperty {
    ...
    companion object {
        ...
        const val ITEM_VERIFY_RES_QUEUE_NAME = "$ITEM_VERIFY_REQ_TOPIC_PREFIX.queue"
        const val ITEM_VERIFY_RES_EXCHANGE_NAME = "$ITEM_VERIFY_REQ_TOPIC_PREFIX.exchange"
        const val ITEM_VERIFY_RES_ROUTING_KEY = "$ITEM_VERIFY_REQ_TOPIC_PREFIX.routing.#"
    }
}